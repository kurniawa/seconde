...
<body class="relative">
    ...
    <div class="min-h-full">
        ...
        <div class="m-2 p-2 rounded border-2 border-emerald-300 text-gray-400">
            @if (Auth::user())
            ...
            <form action="{{ route('logout') }}" method="POST">
                @csrf
                <div class="text-center">
                    <button type="submit" class="rounded-md border-2 border-yellow-400 bg-yellow-200 py-1 px-2 font-medium hover:bg-gray-700 hover:text-white">Sign out</button>
                </div>
            </form>
            @else
            <div class="text-center">
